...
MODELS_ES = {
  ...
  "model-x": dict(name="Model X", img="cars/model-x/model-x-red-studio", gallery=["cars/model-x/model-x-gold-doors","cars/model-x/model-x-gold-side","cars/model-x/model-x-red-1","cars/model-x/model-x-red-2","cars/model-x/model-x-red-3","cars/model-x/model-x-red-4","cars/model-x/model-x-red-5","cars/model-x/model-x-red-6"],
...
SERVICES_ES = {
  ...
  "vinyl-wraps": dict(name="Wrap de Vinilo", img="cars/cybertruck/cybertruck-wrapped-pair", xpel=False,
    section_media=[(0, dict(img="cars/model-x/model-x-gold-logo", w=900, h=900,
        alt="Vinyl wrap dorado junto al logo Tesla negro de un Model X, con corte limpio")),
        (1, dict(img="cars/model-x/model-x-gold-jamb", w=900, h=900,
        alt="Vinyl wrap dorado llevado hasta el estribo y la jamba de la puerta de un Tesla Model X con interior blanco"))],
...
CITIES_ES = {
  "miami": {"name": "Miami", "county": "miami-dade", "img": "cars/model-3/model-3-grey-2",
    ...
    "faqs": [
      ...
      ("Guardo mi Model S o Model X en una torre de Brickell con valet y rampas de garaje estrechas. ¿Qué protege contra los roces?",
       "Las rampas estrechas y el valet de Brickell son donde los Teslas se llevan roces en los estribos y el parachoques inferior, y golpes en los cantos de las puertas; y aquí abundan el Model S y el Model X. El film de protección en estribos, parachoques inferior y cantos de puerta recibe esos golpes, y como el film XPEL se autorregenera, las micro-rayas del valet desaparecen con el calor.")]},
  "miami-beach": {"name": "Miami Beach", "county": "miami-dade", "img": "cars/model-y/model-y-white-3",
    ...
    "faqs": [
      ...
      ("Los excrementos de aves siguen grabando mi Tesla cerca de la playa. ¿La protección ayuda?",
       "En la isla las gaviotas y las aves del puerto son implacables, y con el calor de Miami Beach sus excrementos son lo bastante ácidos para grabar la capa transparente en pocas horas. Un recubrimiento cerámico hace que resbalen y se enjuaguen en vez de adherirse, y el PPF suma una barrera sacrificable. Entre las aves, la arena que vuela y el estacionamiento en calle de temporada turística, cerámico y film es como un Tesla de la playa se mantiene impecable.")]},
  "doral": {"name": "Doral", "county": "miami-dade", "img": "cars/model-s/model-s-blue-1",
    ...
    "intro": [
      ...
      "Doral también tiene una de las mayores concentraciones de Tesla del sur de Florida, y sus corredores comerciales, más el tráfico constante de camiones y obra en el Palmetto (SR-826) y la NW 12th Street, lanzan mucho escombro. Por eso gran parte de nuestro trabajo en Doral es PPF frontal, incluso para las flotas corporativas y los ejecutivos que compran nuevo en el centro Tesla cercano y quieren la pintura protegida desde el primer día."],
    "services": ["paint-protection-film", "window-tint", "ceramic-coating"],
    "faqs": [
      ...
      ("Mi Tesla maneja a diario por los corredores comerciales de Doral y el Palmetto. ¿Eso castiga la pintura?",
       "Sí. Doral vive del tráfico comercial y de camiones, y el Palmetto (SR-826) y la NW 12th Street lanzan sin parar grava y escombros de obra que pican la blanda capa transparente de fábrica del Tesla. La solución es PPF frontal completo o de tipo track en capó, guardabarros, espejos y parachoques; y como estamos a minutos del centro Tesla, muchos traen el auto nuevo directo antes del primer kilómetro de autopista.")]},
  "coral-gables": {"name": "Coral Gables", "county": "miami-dade", "img": "cars/model-s/model-s-red",
    ...
    "faqs": [
      ...
      ("Mi casa en the Gables no tiene garaje y el auto queda bajo los árboles. ¿Qué recomiendan?",
       "Ese es el caso más duro de the Gables: un Tesla estacionado a la intemperie bajo la fronda de banianos y robles recibe savia, polen, flores y excrementos de aves las 24 horas, más sol pleno. Un recubrimiento cerámico para que todo eso se enjuague en vez de grabar, PPF para los escombros que caen y las picaduras, y polarizado cerámico para el calor: esa es la combinación que mantiene impecable a un Tesla del Gables siempre a la intemperie.")]},
  ...
  "weston": {"name": "Weston", "county": "broward", "img": "cars/model-x/model-x-red-2",
    ...
    "faqs": [
      ...
      ("Hacemos el trayecto diario desde Weston por la Turnpike y la I-75 en nuestro Model Y. ¿Cuál es la protección inteligente?",
       "Ese es el caso clásico de Weston: un Model Y familiar que suma kilómetros reales a diario en el borde oeste de Broward por la Florida Turnpike y la I-75, donde la grava y los escombros de autopista pican el frente. El PPF frontal completo o de tipo track en capó, guardabarros, espejos y parachoques es la compra inteligente, y el polarizado cerámico mantiene la cabina fresca para los niños de regreso a casa.")]},
